...
fused_floyd_attention(__gm__ uint8_t *query, __gm__ uint8_t *key0, __gm__ uint8_t *key1, __gm__ uint8_t *value0, 
                      ...
                      __gm__ uint8_t *workspace, __gm__ uint8_t *tiling)
{
    ...
    //     GET_TILING_DATA_WITH_STRUCT(FusedFloydAttentionTilingData, tiling_data_in, tiling);
    //     const FusedFloydAttentionTilingData *__restrict tiling_data = &tiling_data_in;
    //     if (TILING_KEY_IS(90)) {
    //         FusedFloydAttentionEmptyTensor<half> op;
    //         op.Init(softmaxMax, softmaxSum, attentionOut, tiling_data);
    //         op.Process();
    //     } else if (TILING_KEY_IS(92)) {
    //         FusedFloydAttentionEmptyTensor<float> op;
    //         op.Init(softmaxMax, softmaxSum, attentionOut, tiling_data);
    //         op.Process();
    //     } else if (TILING_KEY_IS(94)) {
    //         FusedFloydAttentionEmptyTensor<bfloat16_t> op;
    //         op.Init(softmaxMax, softmaxSum, attentionOut, tiling_data);
    //         op.Process();
    //     }
    //     return;
