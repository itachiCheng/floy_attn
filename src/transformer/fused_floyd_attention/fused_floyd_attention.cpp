...
// #include "fused_floyd_attention_s1_bn2gs1.h"
                      ...
                      __gm__ uint8_t *workspace, __gm__ uint8_t *tiling)
{
    ...
    //     INVOKE_FA_GENERAL_OP_IMPL(FusedFloydAttentionS1s2Bn2gs1, ImplModeEnum::AA_INVALID_LINE_HIGH_PRECISION,
    //                               LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true);
    //     return;
    // } else if (TILING_KEY_IS(10000000000221130943UL)) { // SplitS1S2HighPerf: FLOAT16_PRECISION Bmm1-NZ
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM1NZ(FusedFloydAttentionS1s2Bn2gs1, ImplModeEnum::AA_HIGH_PRECISION,
    //                                      LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true,
    //                                      CubeFormat::NZ);
    //     return;
    // } else if (TILING_KEY_IS(10000000000221132943UL)) { // SplitS1S2HighPerf: FLOAT16_PRECISION Bmm1-NZ
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM1NZ(FusedFloydAttentionS1s2Bn2gs1, ImplModeEnum::AA_INVALID_LINE_HIGH_PRECISION,
    //                                      LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true,
    //                                      CubeFormat::NZ);
    //     return;
    ...
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM2NZ(FusedFloydAttentionS1Bn2gs1, ImplModeEnum::AA_HIGH_PRECISION,
    //                               LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true);
    //     return;
    // } else if (TILING_KEY_IS(10000000002200132953UL)) { // SplitBn2gs1s2S1dDBHighPerf: FLOAT16_PRECISION Bmm1-ND
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM2NZ(FusedFloydAttentionS1Bn2gs1, ImplModeEnum::AA_INVALID_LINE_HIGH_PRECISION,
    //                               LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true);
    //     return;
    ...
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM2NZ(FusedFloydAttentionBn2gs1s2B, ImplModeEnum::AA_HIGH_PRECISION,
    //                               LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true,
    //                               LayoutMode::BSNGD);
    //     return;
    // } else if (TILING_KEY_IS(10000000000021132099UL)) { // SplitBbDBHighPerf: FLOAT16_PRECISION
    //     INVOKE_FA_GENERAL_OP_IMPL_BMM2NZ(FusedFloydAttentionBn2gs1s2B, ImplModeEnum::AA_INVALID_LINE_HIGH_PRECISION,
    //                               LayOutTypeEnum::LAYOUT_BSH, false, false, false, half, float, true,
    //                               LayoutMode::BSNGD);
    //     return;
...
//         INVOKE_FA_GENERAL_OP_IMPL_BMM2NZ(FusedFloydAttentionS1Bn2gs1,
