...
if(NOT DEFINED CMAKE_INSTALL_PREFIX)
  set(CMAKE_INSTALL_PREFIX "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/output")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/packages/vendors/foly_attn/op_api/lib" TYPE SHARED_LIBRARY FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/libcust_opapi.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/packages/vendors/foly_attn/op_proto/lib/linux/aarch64" TYPE SHARED_LIBRARY FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/libcust_opsproto_rt2.0.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/packages/vendors/foly_attn/op_impl/ai_core/tbe/op_tiling/lib/linux/aarch64" TYPE SHARED_LIBRARY FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/libcust_opmaster_rt2.0.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/packages/vendors/foly_attn/op_impl/ai_core/tbe/op_tiling" TYPE FILE FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/compat/liboptiling.so")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/src/utils/cmake_install.cmake")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/tests/cmake_install.cmake")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/src/transformer/flash_attention_score/ophost/cmake_install.cmake")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/." TYPE DIRECTORY PERMISSIONS OWNER_EXECUTE OWNER_READ GROUP_READ FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/scripts/")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/packages/vendors/foly_attn" TYPE FILE FILES "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/version.info")
endif()
...
file(WRITE "/data/Fused_Floyd_Attn_AscendC/cq/foly_attn_proj/build/prepare_build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
